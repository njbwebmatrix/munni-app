...
export const HomepageProduct = () => {
    ...
    return (
        ...
        <div id="sproduct">
            {product.map((el,i) =>
               <Link key={i} className="card" style={{textDecoration: 'none', margin: '5px'}} to={`product/${el.id}`}>
               <div>
               ...
               <div className="tbox">
                   ...
                   <div style={{color:'#999999'}}>
                       {/* <i className='fas fa-badge-percent' style={{fontSize:'24px',color:'#5585F8',margin:'10px'}}>&#xf02c;</i>           */}
                        </div>
                   <div className="free">
                       CoD Available
                   </div>
